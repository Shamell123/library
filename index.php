...
<body class="bg-dark" style="background: url(img/monton.jpg) no-repeat;  background-size:cover">

  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header">
       <h2><center style="color:coral;">User Login</center></h2>
                      <center><a href="admin/index.php"style="text-align:right;">Login as Admin</a>
      ...
      <div class="card-body">
        <form name="login"  method="post" action="">
          ...
          <input type="submit"  class="btn btn-primary btn-block" name="login_btn" value="Login">
                ...
                <div style="margin-top:20px;margin-left:10px"><a href="register-user.php">Sign Up</a>
